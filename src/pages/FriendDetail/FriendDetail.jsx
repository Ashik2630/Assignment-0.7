...
const FriendDetail = () => {
  ...
  const { name, email, picture, tags, status, bio } = friend;
      ...
      <div className="lg:col-span-2 space-y-6 ">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="bg-white rounded-xl shadow-md p-6 text-center">
            <h3 className="text-2xl font-bold text-green-900">62</h3>
            <p className="text-gray-500 text-sm">Days Since Contact</p>
          </div>

          <div className="bg-white rounded-xl shadow-md p-6 text-center">
            <h3 className="text-2xl font-bold text-green-900">30</h3>
        ...
        {/* Relationship Goal */}
        <div className="bg-white rounded-xl shadow-md p-10 flex justify-between items-center">
          <div>
